<?php
	...
	echo "|Temp: " . $response['data']['current_condition'][0]['temp_F'] . "F|Humidity: " . $response['data']['current_condition'][0]['humidity']  . "|Description: " . $response['data']['current_condition'][0]['weatherDesc'][0]['value'];
